...
(function (global) {
  ...
  var TMPL_MAIN = [
    ...
    '        <span style="font-weight:normal;">カメラのアクセス許可を求められます。「許可(Allow)」を押して、カメラ認証を開始し、撮影を続けてください。</span><br>',
    '        <span style="font-size:13px; font-weight:normal; color:#475569; margin-top:4px; display:inline-block;">Bạn sẽ được yêu cầu cấp quyền máy ảnh. Hãy bấm nút cho phép để bắt đầu xác thực và chụp ảnh.</span>',
    '      </div>',
    ...
    '      </div>',
    '      <div class="pu-confirm-btns" id="puSecOverlayBtns" style="flex-direction:column; justify-content:center; gap:8px; margin-top:12px;">',
    '        <button class="pu-confirm-btn" id="puSecBtnPreview" type="button" style="width:auto; align-self:center; font-size:12px; padding:6px 16px; background:transparent; color:#64748b; border:1px solid #cbd5e1;"><i class="fas fa-camera"></i> プレビュー / Preview</button>',
               ...
               if (video && video.readyState >= 2 && video.videoWidth > 0) {
                 ...
                 try {
                   ...
                   c.toBlob(function(b){
                      ...
                      /* Di dời cleanup() sang nút Accept/Cancel để Preview không bị đen */
                   }, 'image/jpeg', 0.9);
                 } catch(e) { cleanup(); }
               }
             }, 150);
