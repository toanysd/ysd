    ...
    renderDesktopQuickActions(item, type) {
      return `
        <div class="dp-actions-grid" style="display:grid; grid-template-columns:repeat(3,1fr); gap:6px; align-items:stretch;">
          <button class="dp-action-btn dp-action-btn--weight" data-action="qu-weight" type="button" title="重量更新 / Cập nhật Khối lượng" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:4px 4px; gap:6px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-weight-hanging" style="font-size:16px; width:18px; text-align:center; color:#f59e0b;"></i>
          ...
          <button class="dp-action-btn dp-action-btn--design" data-action="qu-design" type="button" title="設計情報 / Thông tin Thiết kế" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:4px 4px; gap:6px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-ruler-combined" style="font-size:16px; width:18px; text-align:center; color:#3b82f6;"></i>
            <div style="display:flex; flex-direction:column; align-items:flex-start;">
          ...
          <button class="dp-action-btn dp-action-btn--lifecycle" data-action="qu-lifecycle" type="button" title="運用状況 / Vận hành" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:4px 4px; gap:6px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-truck-loading" style="font-size:16px; width:18px; text-align:center; color:#10b981;"></i>
            <div style="display:flex; flex-direction:column; align-items:flex-start;">
          ...
          <button class="dp-action-btn dp-action-btn--inout" data-action="inout" type="button" title="入出庫・位置変更 / Nhập xuất, chuyển vị trí" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:4px 4px; gap:6px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-map-marker-alt" style="font-size:16px; width:18px; text-align:center; color:#0ea5e9;"></i>
            <div style="display:flex; flex-direction:column; align-items:flex-start;">
          ...
          <button class="dp-action-btn dp-action-btn--inventory" data-action="inventory" type="button" title="棚卸 / Kiểm kê" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:4px 4px; gap:6px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-clipboard-check" style="font-size:16px; width:18px; text-align:center; color:#eab308;"></i>
            <div style="display:flex; flex-direction:column; align-items:flex-start;">
          ...
          <button class="dp-action-btn dp-action-btn--teflon" data-action="teflon" type="button" title="テフロン / Mạ Teflon" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:4px 4px; gap:6px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-paint-roller" style="font-size:16px; width:18px; text-align:center; color:#14b8a6;"></i>
            <div style="display:flex; flex-direction:column; align-items:flex-start;">
          ...
          <button class="dp-action-btn dp-action-btn--print" data-action="print" type="button" title="印刷 / In" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:4px 4px; gap:6px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-print" style="font-size:16px; width:18px; text-align:center; color:#64748b;"></i>
            <div style="display:flex; flex-direction:column; align-items:flex-start;">
          ...
          <button class="dp-action-btn dp-action-btn--photo" data-action="photo" type="button" title="写真 / Ảnh" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:4px 4px; gap:6px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-camera" style="font-size:16px; width:18px; text-align:center; color:#ec4899;"></i>
            <div style="display:flex; flex-direction:column; align-items:flex-start;">
          ...
          <button class="dp-action-btn dp-action-btn--qr" data-action="qr" type="button" title="QRコード / Mã QR" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:4px 4px; gap:6px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-qrcode" style="font-size:16px; width:18px; text-align:center; color:#8b5cf6;"></i>
            <div style="display:flex; flex-direction:column; align-items:flex-start;">
