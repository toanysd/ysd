                      ...
                      <div class="dp-d2-card-body" style="display:flex; flex-direction:column; gap: 12px;">
                         ...
                         <div>
                           ...
                           <div class="dp-actions-grid">
                             <button class="dp-action-btn" type="button" data-jump="design" style="display:flex;flex-direction:row;align-items:center;text-align:left;gap:6px;padding:6px;"><i class="fas fa-drafting-compass"></i><div style="display:flex;flex-direction:column"><span class="dp-action-label-ja">Design</span><span class="sub dp-action-label-vi">Thiết kế</span></div></button>
                             <button class="dp-action-btn" type="button" data-jump="customers" style="display:flex;flex-direction:row;align-items:center;text-align:left;gap:6px;padding:6px;"><i class="fas fa-building"></i><div style="display:flex;flex-direction:column"><span class="dp-action-label-ja">Customers</span><span class="sub dp-action-label-vi">Khách hàng</span></div></button>
                             <button class="dp-action-btn" type="button" data-jump="product" style="display:flex;flex-direction:row;align-items:center;text-align:left;gap:6px;padding:6px;"><i class="fas fa-box"></i><div style="display:flex;flex-direction:column"><span class="dp-action-label-ja">Product</span><span class="sub dp-action-label-vi">Job</span></div></button>
                             <button class="dp-action-btn" type="button" data-jump="storage" style="display:flex;flex-direction:row;align-items:center;text-align:left;gap:6px;padding:6px;"><i class="fas fa-warehouse"></i><div style="display:flex;flex-direction:column"><span class="dp-action-label-ja">Storage</span><span class="sub dp-action-label-vi">Vị trí</span></div></button>
                             <button class="dp-action-btn" type="button" data-jump="transfer" style="display:flex;flex-direction:row;align-items:center;text-align:left;gap:6px;padding:6px;"><i class="fas fa-truck"></i><div style="display:flex;flex-direction:column"><span class="dp-action-label-ja">Transfer</span><span class="sub dp-action-label-vi">Vận chuyển</span></div></button>
                             <button class="dp-action-btn" type="button" data-jump="extended" style="display:flex;flex-direction:row;align-items:center;text-align:left;gap:6px;padding:6px;"><i class="fas fa-arrow-right"></i><div style="display:flex;flex-direction:column"><span class="dp-action-label-ja">Open</span><span class="sub dp-action-label-vi">Mở rộng</span></div></button>
                           </div>
                         </div>
                      </div>
                   </div>
    ...
    renderDesktopQuickActions(item, type) {
      return `
        <div class="dp-actions-grid" style="display:grid; grid-template-columns:repeat(3,1fr); gap:6px; align-items:stretch;">
          <button class="dp-action-btn dp-action-btn--weight" data-action="qu-weight" type="button" title="重量更新 / Cập nhật Khối lượng" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:6px 4px; gap:8px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-weight-hanging" style="font-size:18px; color:#f59e0b;"></i>
          ...
          <button class="dp-action-btn dp-action-btn--design" data-action="qu-design" type="button" title="設計情報 / Thông tin Thiết kế" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:6px 4px; gap:8px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-ruler-combined" style="font-size:18px; color:#3b82f6;"></i>
            <div style="display:flex; flex-direction:column; align-items:flex-start;">
          ...
          <button class="dp-action-btn dp-action-btn--lifecycle" data-action="qu-lifecycle" type="button" title="運用状況 / Vận hành" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:6px 4px; gap:8px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-truck-loading" style="font-size:18px; color:#10b981;"></i>
            <div style="display:flex; flex-direction:column; align-items:flex-start;">
          ...
          <button class="dp-action-btn dp-action-btn--inout" data-action="inout" type="button" title="入出庫・位置変更 / Nhập xuất, chuyển vị trí" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:6px 4px; gap:8px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-map-marker-alt" style="font-size:18px; color:#0ea5e9;"></i>
            <div style="display:flex; flex-direction:column; align-items:flex-start;">
              <span class="dp-action-label-ja" style="font-size:11px; font-weight:700; color:#334155; line-height:1.2;">位置</span>
              <span class="sub dp-action-label-vi" style="font-size:9.5px; color:#64748b; line-height:1.1;">Vị trí</span>
            </div>
          </button>
          <button class="dp-action-btn dp-action-btn--inventory" data-action="inventory" type="button" title="棚卸 / Kiểm kê" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:6px 4px; gap:8px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-clipboard-check" style="font-size:18px; color:#eab308;"></i>
            <div style="display:flex; flex-direction:column; align-items:flex-start;">
          ...
          <button class="dp-action-btn dp-action-btn--teflon" data-action="teflon" type="button" title="テフロン / Mạ Teflon" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:6px 4px; gap:8px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-paint-roller" style="font-size:18px; color:#14b8a6;"></i>
            <div style="display:flex; flex-direction:column; align-items:flex-start;">
              <span class="dp-action-label-ja" style="font-size:11px; font-weight:700; color:#334155; line-height:1.2;">ﾃﾌﾛﾝ</span>
              <span class="sub dp-action-label-vi" style="font-size:9.5px; color:#64748b; line-height:1.1;">Mạ Teflon</span>
            </div>
          </button>
          <button class="dp-action-btn dp-action-btn--print" data-action="print" type="button" title="印刷 / In" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:6px 4px; gap:8px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-print" style="font-size:18px; color:#64748b;"></i>
            <div style="display:flex; flex-direction:column; align-items:flex-start;">
          ...
          <button class="dp-action-btn dp-action-btn--photo" data-action="photo" type="button" title="写真 / Ảnh" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:6px 4px; gap:8px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-camera" style="font-size:18px; color:#ec4899;"></i>
            <div style="display:flex; flex-direction:column; align-items:flex-start;">
          ...
          <button class="dp-action-btn dp-action-btn--qr" data-action="qr" type="button" title="QRコード / Mã QR" style="display:flex; flex-direction:row; align-items:center; justify-content:center; text-align:left; padding:6px 4px; gap:8px; border:1px solid #e2e8f0; border-radius:8px; background:#fff; height:100%;">
            <i class="fas fa-qrcode" style="font-size:18px; color:#8b5cf6;"></i>
            <div style="display:flex; flex-direction:column; align-items:flex-start;">
              <span class="dp-action-label-ja" style="font-size:11px; font-weight:700; color:#334155; line-height:1.2;">QR</span>
      ...
      const renderGrid = (arr, cols) => {
         ...
         for (const f of arr) {
           ...
           if (rawLbl.includes('|||')) {
              ...
              // Format Label NHẬT (Trọng tâm) - Việt (Phụ mờ)
           ...
           html += `
             <div class="ov-item" style="display: flex !important; flex-direction: row !important; align-items: center !important; justify-content: space-between !important; padding: 10px 14px; background: rgba(248, 250, 252, 0.6); border: 1px solid rgba(15, 23, 42, 0.06); border-radius: 12px; gap: 8px;">
               ...
               <div class="info-value" style="flex: 1 1 auto !important; text-align: right !important; word-break: break-word !important; padding: 0 !important; border: none !important; font-size: 14px !important; font-weight: 500 !important; color: #0f172a !important;">${f.rawValue ?? '-'}</div>
             </div>
           `;
         }
         html += `</div>`;
