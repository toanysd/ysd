    ...
    renderInfoTabDesktopMoldCentric() {
      ...
      return `
        <div class="dp-dash2-layout">
           ...
           <div class="dp-dash2-grid">
               <!-- Col 1: Photo (Span 3) -->
               <div class="dp-d2-card col-3 pt-0">
                  <div class="dp-d2-card-body">
                     ${this.renderDesktopPhotoPreview(mold)}
                  </div>
               </div>

               <!-- Col 2: Storage (Span 4) -->
               <div class="dp-d2-card col-4">
               ...
               <!-- Col 3: Actions (Span 5) -->
               <div class="dp-d2-card col-5">
               ...
               <!-- Row 2: Basic Info (Span 6) -->
               <div class="dp-d2-card col-6">
                  <div class="dp-d2-card-head"><i class="fas fa-info-circle"></i> Thông tin chung & Sản phẩm</div>
                  <div class="dp-d2-card-body">
               ...
               <!-- Row 2: Tech Info (Span 6) -->
               <div class="dp-d2-card col-6">
                  <div class="dp-d2-card-head"><i class="fas fa-ruler-combined"></i> Kỹ thuật</div>
                  <div class="dp-d2-card-body">
               ...
               <!-- Row 3: Snapshots (Span 12) -->
               <div class="dp-d2-card col-12">
                  <div class="dp-d2-card-head"><i class="fas fa-history"></i> Lịch sử & Báo cáo</div>
                  <div class="dp-d2-card-body" style="display:grid; grid-template-columns: repeat(auto-fit, minmax(300px,1fr)); gap: 12px;">
                  ...
                  <div class="dp-d2-card-body" style="display:grid; grid-template-columns: repeat(auto-fit, minmax(300px,1fr)); gap: 12px;">
                     ...
                     ${this.centerMold ? `
                       <div>
                         ...
                         <button class="btn-action" style="margin-top:8px" type="button" data-jump="extended">Mở rộng khuôn</button>
                       </div>
                     ` : ''}
                  </div>
               </div>
