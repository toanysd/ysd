...
(function(){
  ...
  function ensureMinimalStyles(){
    ...
    st.textContent = `
      ...
      #dpGlobalLayer .dp-action-btn { flex:none; height:auto; min-height:60px; border-radius:12px; background:#f8fafc; border:1px solid #e2e8f0; box-shadow:0 1px 4px rgba(2,6,23,0.05); display:flex; flex-direction:column; align-items:center; justify-content:center; gap:6px; padding:10px 4px; cursor:pointer; overflow:hidden; }
      #dpGlobalLayer .dp-action-btn:active { transform:scale(0.96); opacity:0.85; border-color:rgba(2,6,23,0.12); }
      #dpGlobalLayer .dp-action-btn i { font-size:20px; width:32px; height:32px; border-radius:10px; display:inline-flex; align-items:center; justify-content:center; flex-shrink:0; margin-bottom: 2px; }
      #dpGlobalLayer .dp-action-btn .dp-label-group { display:flex; flex-direction:column; align-items:center; min-width:0; overflow:hidden; line-height:1.2; text-align:center; width:100%; }
      #dpGlobalLayer .dp-action-btn .dp-label-jp { font-weight:800; font-size:10.5px; color:#1e293b; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:96%; margin-bottom:1px; }
      #dpGlobalLayer .dp-action-btn .dp-label-vi { font-weight:700; font-size:9px; color:#64748b; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:96%; opacity:1; }
      ...
      #dpGlobalLayer .dp-assistive-menu .dp-assistive-actions { display:grid; grid-template-columns:repeat(3, 1fr); gap:8px; }
    `;
