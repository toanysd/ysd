                      ...
                      <div class="dp-d2-card-body" style="display:flex; flex-direction:column; gap: 12px;">
                         ...
                         <div>
                           ...
                           <div class="dp-actions-grid">
                             <button class="dp-action-btn" type="button" data-jump="design"><i class="fas fa-drafting-compass" style="color:#3b82f6;"></i><div style="display:flex;flex-direction:column"><span class="dp-action-label-ja">Design</span><span class="sub dp-action-label-vi">Thiết kế</span></div></button>
                             <button class="dp-action-btn" type="button" data-jump="customers"><i class="fas fa-building" style="color:#8b5cf6;"></i><div style="display:flex;flex-direction:column"><span class="dp-action-label-ja">Customers</span><span class="sub dp-action-label-vi">Khách hàng</span></div></button>
                             <button class="dp-action-btn" type="button" data-jump="product"><i class="fas fa-box" style="color:#f59e0b;"></i><div style="display:flex;flex-direction:column"><span class="dp-action-label-ja">Product</span><span class="sub dp-action-label-vi">Job</span></div></button>
                             <button class="dp-action-btn" type="button" data-jump="storage"><i class="fas fa-warehouse" style="color:#10b981;"></i><div style="display:flex;flex-direction:column"><span class="dp-action-label-ja">Storage</span><span class="sub dp-action-label-vi">Vị trí</span></div></button>
                             <button class="dp-action-btn" type="button" data-jump="transfer"><i class="fas fa-truck" style="color:#6366f1;"></i><div style="display:flex;flex-direction:column"><span class="dp-action-label-ja">Transfer</span><span class="sub dp-action-label-vi">Vận chuyển</span></div></button>
                             <button class="dp-action-btn" type="button" data-jump="extended"><i class="fas fa-arrow-right" style="color:#475569;"></i><div style="display:flex;flex-direction:column"><span class="dp-action-label-ja">Open</span><span class="sub dp-action-label-vi">Mở rộng</span></div></button>
                           </div>
                         </div>
                      </div>
                   </div>
