    ...
    renderOverviewSection(item, type) {
      ...
      const nameBadge = `
        <div style="font-size: 16px; font-weight: 800; color:#0f172a; line-height: 1.2;">
           ${isMold 
             ? `<span class="dp-badge-cutter-no" style="background:var(--dp-mold-theme); margin-right: 6px; font-size: 11px; padding: 2px 6px;">MOLD</span>` 
             : `<span class="dp-badge-cutter-no" style="background:var(--dp-cutter-theme); margin-right: 6px; font-size: 11px; padding: 2px 6px;">CUTTER</span>`}
           ${itemName}
        </div>
      `;
      ...
      const row2 = [ { label: this.biLabel('タイプ', 'Kiểu'), rawValue: itemType, customClass: 'type-row' } ];
