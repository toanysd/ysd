    ...
    renderDesktopQuickActions(item, type) {
      return `
        <div class="modal-section" style="margin-bottom:8px;">
          ...
          <div class="dp-actions-grid" style="grid-template-columns: repeat(3, minmax(0, 1fr));">
            <button class="dp-action-btn dp-action-btn--weight" data-action="qu-weight" type="button" title="重量更新 / Cập nhật Khối lượng">
              <i class="fas fa-weight-hanging"></i>
              <span class="dp-action-label-ja">重量</span>
              <span class="sub dp-action-label-vi">Khối lượng</span>
            </button>
            <button class="dp-action-btn dp-action-btn--design" data-action="qu-design" type="button" title="設計情報 / Thông tin Thiết kế">
              <i class="fas fa-ruler-combined"></i>
              <span class="dp-action-label-ja">設計</span>
              <span class="sub dp-action-label-vi">Thiết kế</span>
            </button>
            <button class="dp-action-btn dp-action-btn--lifecycle" data-action="qu-lifecycle" type="button" title="運用状況 / Vận hành">
              <i class="fas fa-truck-loading"></i>
              <span class="dp-action-label-ja">運用</span>
              <span class="sub dp-action-label-vi">Vận hành</span>
            </button>
          </div>
        </div>
        ...
        <div class="modal-section">
          ...
          <div class="dp-actions-grid" style="grid-template-columns: repeat(3, minmax(0, 1fr));">
            <button class="dp-action-btn dp-action-btn--inout" data-action="inout" type="button" title="入出庫・位置変更 / Nhập xuất, chuyển vị trí">
              ...
              <span class="sub dp-action-label-vi">Nhập xuất, V.trí</span>
            </button>
            ...
            <button class="dp-action-btn dp-action-btn--teflon" data-action="teflon" type="button" title="テフロン / Mạ Teflon">
              ...
              <span class="dp-action-label-ja">テフロン</span>
            ...
            <button class="dp-action-btn dp-action-btn--qr" data-action="qr" type="button" title="QRコード / Mã QR">
              <i class="fas fa-qrcode"></i>
              <span class="dp-action-label-ja">QRコード</span>
