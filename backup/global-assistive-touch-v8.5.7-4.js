...
(function(){
  ...
  function ensureMinimalStyles(){
    ...
    st.textContent = `
      ...
      #dpGlobalLayer .dp-action-btn { flex:none; height:auto; min-height:48px; border-radius:12px; background:#f8fafc; border:1px solid #e2e8f0; box-shadow:0 1px 4px rgba(2,6,23,0.05); display:flex; flex-direction:row; align-items:center; justify-content:flex-start; gap:8px; padding:6px 10px; cursor:pointer; overflow:hidden; }
      #dpGlobalLayer .dp-action-btn:active { transform:scale(0.98); opacity:0.85; border-color:rgba(2,6,23,0.12); }
      #dpGlobalLayer .dp-action-btn i { font-size:16px; width:30px; height:30px; border-radius:8px; display:inline-flex; align-items:center; justify-content:center; flex-shrink:0; }
      #dpGlobalLayer .dp-action-btn .dp-label-group { display:flex; flex-direction:column; align-items:flex-start; min-width:0; overflow:hidden; line-height:1.2; text-align:left; }
      #dpGlobalLayer .dp-action-btn .dp-label-jp { font-weight:800; font-size:11px; color:#1e293b; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:100%; margin-bottom:1px; }
      #dpGlobalLayer .dp-action-btn .dp-label-vi { font-weight:700; font-size:9.5px; color:#64748b; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:100%; opacity:1; }

      /* ====== SHARED ACTION COLORS ====== */
      #dpGlobalLayer .dp-action-btn[data-action="qu-weight"] { background:#fffbeb; border-color:#fef3c7; }
      #dpGlobalLayer .dp-action-btn[data-action="qu-weight"] i { background:#fef3c7; color:#d97706; }
      #dpGlobalLayer .dp-action-btn[data-action="qu-design"] { background:#eff6ff; border-color:#dbeafe; }
      #dpGlobalLayer .dp-action-btn[data-action="qu-design"] i { background:#dbeafe; color:#2563eb; }
      #dpGlobalLayer .dp-action-btn[data-action="qu-lifecycle"] { background:#ecfdf5; border-color:#d1fae5; }
      #dpGlobalLayer .dp-action-btn[data-action="qu-lifecycle"] i { background:#d1fae5; color:#059669; }
      #dpGlobalLayer .dp-action-btn[data-action="inout"], #dpGlobalLayer .dp-action-btn[data-action="move"] { background:#fff8e1; border-color:#ffecb3; }
      #dpGlobalLayer .dp-action-btn[data-action="inout"] i, #dpGlobalLayer .dp-action-btn[data-action="move"] i { background:#ffe082; color:#e65100; }
      #dpGlobalLayer .dp-action-btn[data-action="checkin"] { background:#f0fdf4; border-color:#dcfce7; }
      #dpGlobalLayer .dp-action-btn[data-action="checkin"] i { background:#bbf7d0; color:#15803d; }
      #dpGlobalLayer .dp-action-btn[data-action="checkout"] { background:#fff1f2; border-color:#ffe4e6; }
      #dpGlobalLayer .dp-action-btn[data-action="checkout"] i { background:#fecdd3; color:#be123c; }
      #dpGlobalLayer .dp-action-btn[data-action="inventory"] { background:#f0fdfa; border-color:#ccfbf1; }
      #dpGlobalLayer .dp-action-btn[data-action="inventory"] i { background:#99f6e4; color:#0f766e; }
      #dpGlobalLayer .dp-action-btn[data-action="teflon"] { background:#ecfdf5; border-color:#a7f3d0; }
      #dpGlobalLayer .dp-action-btn[data-action="teflon"] i { background:#6ee7b7; color:#047857; }
      #dpGlobalLayer .dp-action-btn[data-action="qr"] { background:#f0f9ff; border-color:#e0f2fe; }
      #dpGlobalLayer .dp-action-btn[data-action="qr"] i { background:#bae6fd; color:#0369a1; }
      #dpGlobalLayer .dp-action-btn[data-action="photo"] { background:#faf5ff; border-color:#f3e8ff; }
      #dpGlobalLayer .dp-action-btn[data-action="photo"] i { background:#e9d5ff; color:#7e22ce; }
      #dpGlobalLayer .dp-action-btn[data-action="print"] { background:#f8fafc; border-color:#f1f5f9; }
      #dpGlobalLayer .dp-action-btn[data-action="print"] i { background:#e2e8f0; color:#475569; }
      ...
      @media (max-width: 768px) {
        ...
        #dpGlobalLayer .dp-mobile-actionbar .dp-actions-grid { display:grid; grid-template-columns:repeat(2, 1fr); gap:8px; width:100%; }
        #dpGlobalLayer .dp-mobile-actionbar .dp-action-btn .sub { display:block !important; }
      ...
      #dpGlobalLayer .dp-assistive-menu .dp-assistive-actions { display:grid; grid-template-columns:1fr 1fr; gap:8px; }
    `;
