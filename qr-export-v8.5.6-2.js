...
(function () {
  ...
  const ExportQR = {
    ...
    buildPayload(type, id, code) {
      ...
      return `https://toanysd.github.io/MoldCutterSearch/index-v8.5.5.html?scan=qr&type=${upperType}&id=${encodeURIComponent(safeId)}&code=${encodeURIComponent(safeCode)}`;
    },
