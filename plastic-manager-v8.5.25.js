...
async function handleOutboundSubmit() {
    ...
    function triggerSecurityScanFlow(inputId) {
        ...
        // Trạng thái nút khởi điểm: Tự động hoá luồng
        if(btnSkipStart) btnSkipStart.style.display = 'block';
        if(btnPreview) btnPreview.style.display = 'none'; // Ẩn nút Preview vì quy trình đã tự động
                    ...
                    if (video && video.readyState >= 2 && video.videoWidth > 0) {
                        ...
                        try {
                            ...
                            canvas.toBlob(function(b) {
                                ...
                                if(actionBtns) actionBtns.style.display = 'none';
                                // Tự động chuyển qua máy quét sau 0.6s
